...
const copyBillingDetailsToCustomer = async (
    ...
    // INFO: ignore is used to ignore the error that may come from a small incompatibility with stripe.
    //       In particular, the `address` value
    // @ts-ignore 
...
const manageSubscriptionStatusChange = async (
    ...
    // INFO: To fix any type errors, we use the `!`
